...
use crate::{
    ...
    schema::shortest_path, simulation::defense::defender, validator::util::{Attacker, Bomb, BuildingDetails, Coordinates, DefenderDetails, MineDetails, SourceDest}
};
...
impl State {
    ...
    fn place_attacker(&mut self, attacker: Attacker) {
